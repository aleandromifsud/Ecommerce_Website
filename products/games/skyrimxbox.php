...
<?php navBarCommon(); ?>
    <div id="sectionID" class="container-fluid">
        ...
        <h1 class="categoryHeads text-center">Skyrim for Xbox One</h1>

        <h4>The epic fantasy from Bethesda Game Studios</h4>

        <div class="row text-center previews productDiv">
            <div id="productImage" class=" col-xs-4 col-sm-offset-2 text-right">
                <a href="#"><img class="img-fluid" src="../../media/products/games/skyrimxbox360.jpg"></a>
            </div>
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">Skyrim on Xbox One</li>
                        </ul>
