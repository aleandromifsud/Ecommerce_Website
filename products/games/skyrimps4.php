...
<?php navBarCommon(); ?>
    <div id="sectionID" class="container-fluid">
        ...
        <h1 class="categoryHeads text-center">Skyrim for PS4</h1>
        ...
        <div class="row text-center previews productDiv">
            <div id="productImage" class=" col-xs-4 col-sm-offset-2 text-right">
                <a href="#"><img class="img-fluid" src="../../media/products/games/skyrimps4.jpg"></a>
            </div>
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">Skyrim on PS4</li>
                        </ul>
