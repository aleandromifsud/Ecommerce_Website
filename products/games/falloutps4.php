...
<?php navBarCommon(); ?>
    <div id="sectionID" class="container-fluid">
        ...
        <h1 class="categoryHeads text-center">Fallout 4 for Playstation 4</h1>

        <h4>A post-apocalyptic role-playing game developed by Bethesda Game Studios and published by Bethesda Softworks.</h4>

        <div class="row text-center previews productDiv">
            <div id="productImage" class=" col-xs-4 col-sm-offset-2 text-right">
                <a href="#"><img class="img-fluid" src="../../media/products/games/fallout4ps4.jpg" alt="Fallout 4"></a>
            </div>
