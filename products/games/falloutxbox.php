...
<?php navBarCommon(); ?>
    <div id="sectionID" class="container-fluid">
        ...
        <h1 class="categoryHeads text-center">Fallout 4 for Xbox 1</h1>
        ...
        <div class="row text-center previews productDiv">
            <div id="productImage" class=" col-xs-4 col-sm-offset-2 text-right">
                <a href="#"><img class="img-fluid" src="../../media/products/games/fallout4xbox.jpg" alt="Fallout 4"></a>
            </div>
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">Fallout 4 on Xbox One</li>
                        </ul>
