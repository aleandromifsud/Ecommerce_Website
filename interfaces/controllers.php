...
$cursor = $collection->find(["category" => "Controllers"]);
?>
...
<div id="sectionID" class="container-fluid">
    ...
    <h1 class="categoryHeads text-center">Controllers</h1>

    <h4>Stylish controllers to make your console sessions fun.</h4>
