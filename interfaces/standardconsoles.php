...
$cursor = $collection->find(["category" => " Standard Consoles"]);
?>
...
<div id="sectionID" class="container-fluid">
    ...
    <h1 class="categoryHeads text-center">Home Consoles</h1>

    <h4>Choose from Microsoft's XBox, Sony's PS4, or travel back in time with Nintendo's re-release of the classic
        NES</h4>
