...
$cursor = $collection->find(["category" => "Prebuilt PC"]);
?>
...
<div id="sectionID" class="container-fluid">
    ...
    <h1 class="categoryHeads text-center">Prebuilt Computers</h1>

    <h4>Fine-tuned gaming machines to meet every gamer's needs. Hand built with care especially for you.</h4>
